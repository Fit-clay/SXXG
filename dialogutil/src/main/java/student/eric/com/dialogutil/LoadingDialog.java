...
public class LoadingDialog extends Dialog {
    ...
    public LoadingDialog(Context context, boolean isTrans) {
        super(context, isTrans ? R.style.loading_dialog : R.style.loading_dialog);
        init(context);
    }

    private void init(Context context) {
        mContext =context;
        setContentView(R.layout.widget_loding_dialog_view);
